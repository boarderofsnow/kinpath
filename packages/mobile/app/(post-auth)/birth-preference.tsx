...
export default function BirthPreferenceScreen() {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <View style={styles.iconCircle}>
            <Ionicons name="flower-outline" size={32} color={colors.brand[500]} />
          </View>
          <Text style={styles.title}>Birth preference</Text>
        ...
        <View style={styles.grid}>
          {TAG_NAMESPACES.birth.values.map((opt) => (
            <PressableScale
              ...
              style={[
                styles.optionCard,
                preferences.birth_preference === opt.value && styles.optionCardActive,
              ]}
              onPress={() =>
                updatePreferences((p) => ({ ...p, birth_preference: opt.value as any }))
              }
            >
              <Text
                style={[
                  styles.optionText,
                  preferences.birth_preference === opt.value && styles.optionTextActive,
                ]}
              >
                {opt.label}
              </Text>
      ...
      <View style={styles.actions}>
        <PressableScale
          ...
          onPress={() => router.replace("/(post-auth)/feeding")}
        >

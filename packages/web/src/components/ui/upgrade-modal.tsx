...
export function UpgradeModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative mx-4 w-full max-w-md overscroll-contain rounded-2xl border border-stone-200/60 bg-white p-6 shadow-xl">
        {/* Close button */}
        <button
          onClick={onClose}
          aria-label="Close"
        ...
        {/* Heading */}
        <h2 id="upgrade-modal-title" className="text-center text-xl font-bold text-stone-900">
        ...
        <div className="mt-5 space-y-3">
          <div className="flex items-center gap-3 rounded-lg bg-stone-50 px-3 py-2.5">
            <MessageCircle className="h-4 w-4 flex-shrink-0 text-brand-500" aria-hidden="true" />
            <span className="text-sm text-stone-700">Unlimited AI questions</span>
          </div>
          <div className="flex items-center gap-3 rounded-lg bg-stone-50 px-3 py-2.5">
            <BookOpen className="h-4 w-4 flex-shrink-0 text-brand-500" aria-hidden="true" />
            <span className="text-sm text-stone-700">Full resource library with child filtering</span>
          </div>
          <div className="flex items-center gap-3 rounded-lg bg-stone-50 px-3 py-2.5">
            <Users className="h-4 w-4 flex-shrink-0 text-brand-500" aria-hidden="true" />

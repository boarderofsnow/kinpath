  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        ...
        <div className="mt-6 rounded-2xl border border-stone-200/60 bg-white shadow-card">
          {/* Resource header */}
          ...
          {/* Divider */}
          <hr className="mx-6 mt-6 border-stone-200/60 sm:mx-8" />
          ...
          {resource.source_url && (() => {
            ...
            return org ? (
              <div className="mx-6 mb-6 rounded-xl bg-sage-50 p-4 sm:mx-8 sm:mb-8">
              ...
              <div className="mx-6 mb-6 rounded-xl bg-stone-50 p-4 sm:mx-8 sm:mb-8">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-1 rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-600 transition-colors shadow-sm"
          >
            <svg
              className="h-4 w-4"
              fill="none"
